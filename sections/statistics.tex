...
\begin{frame}{Erwartungstreue Schätzer}{}
	...
	\begin{itemize}
		...
		\item Demgegenüber ist $\sigmasquML$ \textbf{nicht} erwartungstreu.
			Man kann diesen Schätzer jedoch durch eine geeignete Transformation zu einem erwartungstreuen Schätzer machen.
			Dies führt auf die \keyword{empirische Varianz}
...
\begin{frame}{Erwartete quadratische Abweichung (MSE)}{}
	...
	Die $\MSE\bigl[ \thetaest, \theta \bigr]$ reduziert sich für erwartungstreue Schätzer $\thetaest$ auf die Varianz $\V\bigl[ \thetaest \bigr]$. \\
	\vspace*{2mm}
	\begin{myproof}
