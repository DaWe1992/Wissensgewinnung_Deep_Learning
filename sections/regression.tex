...
\begin{frame}{Eine probabilistische Sicht}{}
	\begin{boxGray}
		...
		\end{equation}
		zusammen. Dabei ist $\varepsilon \in \R$ ein Fehlerterm, der nicht modellierte Effekte oder Datenrauschen modelliert.
	\end{boxGray}
...
\begin{frame}{Maximum-Likelihood Regression (Forts.)}{}
	\begin{itemize}
		\item Die Log-Likelihood ist damit gegeben durch
		\begin{equation}
			\begin{aligned}
				l(\btheta)
					&\coloneqq \ln
