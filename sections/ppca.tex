...
\begin{frame}{Bestimmung des Posteriors (Forts.)}{}
	\begin{itemize}
		\item Nun haben wir alles zusammen, um den Posterior mit Satz \ref{th:cond-norm} auszurechnen.
...
\begin{frame}{Bestimmung des Posteriors (Forts.)}{}
	...
	\begin{boxGray}
		\textbf{Bemerkung:} Dasselbe Ergebnis erhält man, wenn man den Satz von Bayes \ref{th:bayes-norm}
