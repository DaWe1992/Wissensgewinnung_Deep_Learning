...
\begin{frame}{Beispiel II}{}
	...
	\begin{boxGray}
		...
		Die Anwendung der Transformationsformel \ref{th:transformation} ergibt daher für die Dichte $p_{\by}$ von $\by$
		den Ausdruck
		\begin{equation*}
...
\begin{frame}{Aufgabe: Bedingte Normalverteilung}{}
	\begin{mytask}[task:stat-cond-norm]
		...
		Benutzen Sie hierzu die Formeln aus Satz \ref{th:cond-norm}.
	\end{mytask}
\end{frame}
