...
\begin{frame}{Multivariate Normalverteilung}{}
	...
	\begin{mytheo}[th:std-norm-mv]
		...
		\begin{equation*}
			n_{\bx}(\bx) \coloneqq \frac{1}{(2 \pi)^{\frac{N}{2}}} \cdot \exp\left( -\frac{\Vert \bx \Vert^2}{2} \right).
		\end{equation*}
	\end{mytheo}
...
\begin{frame}{Multivariate Normalverteilung (Forts.)}{}
	...
	\begin{mydef}[def:norm-mv]
		...
		\begin{equation*}
			n_{\bx}(\bx) \coloneqq \frac{1}{(2 \pi)^{\frac{N}{2}} \cdot (\det \bSigma)^{\frac{1}{2}}} \cdot \exp\left(
...
\begin{frame}{Aufgabe: Bedingte Normalverteilung}{}
	\begin{mytask}[task:stat-cond-norm]
		...
		\end{equation*}
		sodass die Verbunddichte von $X_1$ und $X_2$ gegeben ist durch
		$p_{X_1, X_2}(x_1, x_2) \coloneqq n(\bx; \bmu, \bSigma)$.
		Bestimmen Sie die Dichte der bedingten Verteilung $p_{X_1\,\mid\,X_2}(x_1 \mid x_2 = -1)$.
...
\begin{frame}{Normale Randverteilung}
	...
	\begin{myproof}
		...
		\begin{equation*}
			n_{\bx}(\bx) = \int n_{\bx, \by}(\bx, \by)\,\diff \by.
		\end{equation*}
...
\begin{frame}{Aufgabe: Normale Randverteilung}{}
	\begin{mytask}[task:stat-norm-marginal]
		Betrachten Sie erneut die Verbunddichte $p_{X_1, X_2}(x_1, x_2)$
		wie sie in Aufgabe \ref{task:stat-cond-norm} definiert wurde.
